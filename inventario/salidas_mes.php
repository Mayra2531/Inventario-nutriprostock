...
$salidas = $conexion->query("
    SELECT p.nombre, p.precio, m.cantidad, m.fecha, m.sucursal, m.nombre_usuario,
           s.nombre_sucursal
    FROM movimientos m
...
<head>
    ...
    <title>NutriProStock - Salidas del Mes</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1><i class="fas fa-arrow-up"></i> Salidas del Mes</h1>
            <div class="stat-badge">
                <div class="number">-<?php echo $total_salidas; ?></div>
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <tbody>
                    <?php while($fila = $salidas->fetch_assoc()): ?>
                    <tr>
                        <td><strong><?php echo htmlspecialchars($fila['nombre']); ?></strong></td>
                        <td>$<?php echo number_format($fila['precio'], 2); ?></td>
                        <td><span class="badge-salida">-<?php echo $fila['cantidad']; ?> unidades</span></td>
                        <td><?php echo htmlspecialchars($fila['nombre_sucursal'] ?? $fila['sucursal'] ?? 'N/A'); ?></td>
                        <td><?php echo htmlspecialchars($fila['nombre_usuario'] ?? 'N/A'); ?></td>
            ...
            <div class="empty-state">
                ...
                <h3>No hay salidas este mes</h3>
                <p>Aún no se han registrado salidas de productos en el mes actual</p>
            </div>
            <?php endif; ?>
        </div>
    </main>
